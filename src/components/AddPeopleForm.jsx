...
const AddPeopleForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Navigate to home view after successful addition
  ...
  return (
    ...
    >
      ...
      <div>
        <label className="block mb-1 text-sm font-medium text-gray-600">Payment Amount</label>
        <input
          type="number"
          value={payment}
      ...
      <div>
        <label className="block mb-1 text-sm font-medium text-gray-600">Payment Received</label>
        <input
          type="number"
